...
Once you have edited your function you can use the following command lines to build, test and deploy your function to AWS Lambda from the command line (these examples assume the project name is *TranslateBatch*):
...
Execute unit tests
```
    cd "TranslateBatch/test/TranslateBatch.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "TranslateBatch/src/TranslateBatch"
